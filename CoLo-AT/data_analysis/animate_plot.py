...
class Animator():
	...
	def __init__(self, dataset_labels, data_recorder, analyzer):
		...
		self.robot_loc_time_unit = analyzer.robot_location_at_unit_time_interval(state_recorder)
	...
	def animate_plot(dataset_labels, data_recorder, analyzer, lm = None):
		self.robot_locations_gt = get_robot_locations(num_robots, self.robot_loc_time_unit, 'gt')
		self.robot_locations_est = get_robot_locations(num_robots, self.robot_loc_time_unit, 'est')
